...
public class DataKuliner {
        ...
        public static ArrayList<com.example.kulinerr311910167.ModelKuliner> ambilDataKuliner() {
                ArrayList<com.example.kulinerr311910167.ModelKuliner> dataKuliner = new ArrayList<>();
                for (String[] varData : data) {
                        com.example.kulinerr311910167.ModelKuliner model = new com.example.kulinerr311910167.ModelKuliner();
